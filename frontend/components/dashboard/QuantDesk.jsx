  ...
  return (
    <DataState isLoading={isLoading} error={error}>
      <div className="space-y-6">
        <Panel className="p-5">
          <p className="font-mono text-xs uppercase tracking-wideish text-paper-muted">Where the scripts live</p>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-4 inline-block rounded border border-paper-line px-3 py-1.5 font-mono text-xs uppercase tracking-wideish text-paper-ink/80 transition hover:border-signal-amber-ink hover:text-signal-amber-ink"
          >
